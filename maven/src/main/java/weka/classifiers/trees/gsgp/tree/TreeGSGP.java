 ...
 *
 */
public class TreeGSGP implements Tree {
	/**
	 * 
	 */
	 ...
	 * @param test_rmse
	 */
	public TreeGSGP(double [] parentsIds, Node head,double [] train_semantic, 
	 ...
	 * @param target
	 */
	public TreeGSGP(String [] op, String [] term, double t_rate, int depth, double[][] data, double train_p, double [] target, int id){
		
		head = new Node(op, term, t_rate,0, depth);
		train_semantic = TreeGSGPOperations.semantic(this,data,train_p);
		test_semantic = TreeGSGPOperations.semantic(this,data,-train_p);
	 ...
	 * Clones a tree
	 */
	public TreeGSGP clone(){
		TreeGSGP ret = new TreeGSGP();
